...
def render_visualizations(
    ...
    if current_view == "🎯 Cluster Plot":
        ...
        *PC1 explains ~{pc1_var}% of variance (X-axis) and PC2 explains ~{pc2_var}% of variance (Y-axis); Combined variance explained ~{combined_var}%*
        ...
        # ---------------------------------------------------------
        st.markdown(f"""
        #### 📌 Quadrant Overview: **{quadrant_label} – {quadrant_name}**{selected_ticker}** is positioned in this quadrant based on **PC1 ({PC1_INTERPRETATION['name']})** and **PC2 ({PC2_INTERPRETATION['name']})**
